...
/**
 * Test class to test {@link DeleteArticleEndpoint}.
 * 
 * @author Caleb L. Power
 */
@PrepareForTest({ Stentor.class }) public final class DeleteArticleEndpointTest {
  ...
  /**
   * Tests {@link DeleteArticleEndpoint#doEndpointTask(Request, Response, AuthToken)}
